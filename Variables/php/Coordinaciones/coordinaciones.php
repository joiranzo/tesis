...
<body>
    <div class="conte_gral">
        <div class="barra_menu">
            <div class="titulo">Coordinaciones</div>
            <div class="menu">
        ...
        <div class="table">
            ...
            <div class="titulos">
                <div class="c2">Nombre de la Coordnación</div>
                <div class="c3"></div>
            </div>
            ...
            <div class="cuerpo">
                ...
                <?php 
                    ...
                    <form class="fila visible_flex" action="actualizar.php" method="post">
                        <input class="c2 campo" disabled name="NomSupervision" value ="<?php echo $row['NomCoordinacion'] ?>"></input>
                        <div class="c3 ">
