...
<body>
    <div class="conte_gral">
        <div class="barra_menu">
            <div class="titulo">Coordinadores</div>
            <div class="menu">
        ...
        <div class="table">
            ...
            <div class="titulos">
                <div class="c2">Nombre del Coordinador</div>
                <div class="c3"></div>
            </div>
            ...
            <div class="cuerpo">
                ...
                <?php 
                    ...
                    <form class="fila visible_flex" action="actualizar.php" method="post">
                        <input class="c2 campo" disabled name="NomSupervision" value ="<?php echo $row['NomCoordinador'] ?>"></input>
                        <div class="c3 ">
