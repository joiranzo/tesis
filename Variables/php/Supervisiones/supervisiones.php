...
<body>
    <div class="conte_gral">
        <div class="barra_menu">
            <div class="titulo">Supervisiones</div>
            <div class="menu">
            ...
            <div class="cuerpo">
                ...
                <?php 
                    ...
                    <form class="fila visible_flex" action="actualizar.php" method="post">
                        <input class="c2 campo" disabled name="NomSupervision" value ="<?php echo $row['NomSupervision'] ?>"></input>
                        <div class="c3 ">
